...
//    @Pointcut("target(org.springframework.data.repository.Repository)")
     ...
     */
    @Pointcut("com.svtsygankov.spring.aop.CommonPointcuts.isControllerLayer() && @annotation(org.springframework.web.bind.annotation.GetMapping)")
    ...
    /*
        ...
        * - any param type
        .. - 0+ any params type
     */
    @Pointcut("com.svtsygankov.spring.aop.CommonPointcuts.isControllerLayer() && args(org.springframework.ui.Model,..)")
    public void hasModelParam() {
    }

    @Pointcut("com.svtsygankov.spring.aop.CommonPointcuts.isControllerLayer() && @args(com.svtsygankov.spring.validation.UserInfo,..)")
